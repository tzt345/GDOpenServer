...
$sessionGrantsTime = 60; // Time in minutes, for how much time until a GJP check session expires for an IP, set to 0 or lower permanently grant access to the IP.
