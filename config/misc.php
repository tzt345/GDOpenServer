...
/* If it does not redirect, it works like this: Based on how many songs an artists has on the songs index of the server, artists get higher on the top song makers.
