...
if ($maximumAccountDownloads != 0 AND $query6->fetchColumn() < $maximumAccountDownloads) {
...
if ($gameVersion > 19) {
	...
	$xor = new XORCipher();
	$pass = base64_encode($xor->cipher($pass, 26364));
} else {
