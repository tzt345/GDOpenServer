...
function sendVerificationMail($email, $secret, $accountID) {
	...
	$mail->isHTML(true);
	$mail->Subject = "Please verify your $gdps_name account.";
	$mail->From = $from;
	$mail->FromName = "$gdps_name";
	...
	$mail->Body = "<center>
		<div style='width=80%;height=80%;border: 2px solid #000;'>
			...
			<strong>Thank you for registering on $gdps_name!</strong>
		...
		<span style='font-size: x-small;'>This is not a Newsletter E-Mail and was only sent to you because you have registered on $gdps_name.<br>
		Please do not reply.</span></center><br>";
	$mail->AltBody = "You received this E-Mail because you registered on $gdps_name. Please verify your account using the following link: $URL";
	$mail->send();
}
?>
